...
/**
 * VersionCompat for MC 1.21.5+
 * Major API changes: Tag accessors renamed, CompoundTag.getAllKeys->keySet,
 * HIDE_TOOLTIP/HIDE_ADDITIONAL_TOOLTIP removed, Unbreakable simplified,
 * DyedItemColor(int) only, Inventory.selected private, showInTooltip removed
 */
public class VersionCompat {
    ...
    // --- Tooltip rendering (1.21.6: renderTooltip(Font,Component,int,int) removed) ---
    public void renderTooltip(net.minecraft.client.gui.GuiGraphics g, net.minecraft.client.gui.Font f, net.minecraft.network.chat.Component tooltip, int mx, int my) {
