...
/**
 * VersionCompat for Fabric MC 1.21.2
 * API: lookupOrThrow, listElementIds, reg.get(), DAMAGE_RESISTANT, int CustomModelData,
 * FoodProperties 3 params, old NBT accessors, inv.selected, HIDE_TOOLTIP exists,
 * Unbreakable(boolean), DyedItemColor(int,boolean), ItemAttributeModifiers(list,boolean),
 * renderTooltip 4 params
 */
