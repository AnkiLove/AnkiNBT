...
public final class NbtFileIO {
    ...
    public static Path exportNbt(class_2487 tag, String fileName, String category, String alias) {
        try {
    ...
    public static Path exportNbtToPath(class_2487 tag, Path file, String alias) {
    ...
    public static Path exportNbtToPath(class_2487 tag, Path file) {
        return NbtFileIO.exportNbtToPath(tag, file, null);
    }

    public static Path exportNbt(class_2487 tag, String fileName) {
    ...
    public static class_2487 importNbt(Path file) {
    ...
    public static class_2487 autoLoadLast() {
