...
public class NbtEditorScreen extends Screen {
    ...
    private void initSearchBox() {
        ...
        searchBox = new FlatEditBox(font, treeX + 2, treeY + 1, Math.max(1, treeW - 4), ROW_H - 2, Component.translatable("ankinbt.search.hint"));
    ...
    public void render(GuiGraphics g, int mx, int my, float pt) {
        ...
        if (searching) {
            ...
            searchBox.renderWidget(g, mx, my, pt);
    ...
    private void openEditor(NbtTreeNode node) {
        Minecraft.getInstance().setScreenAndShow(new ValueEditScreen(this, node));
    }
    ...
    private void addTag() {
        ...
        Minecraft.getInstance().setScreenAndShow(new AddTagScreen(this, target));
    }
    ...
    private void switchToSimple() {
        ...
        Minecraft.getInstance().setScreenAndShow(new SimpleEditorScreen(originalStack, inventorySlot));
    }
