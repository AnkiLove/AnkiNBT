...
/**
 * VersionCompat for Fabric MC 1.21.5
 * API: keySet, value(), getString().orElse(), getSelectedSlot(), no HIDE_TOOLTIP,
 * Unit.INSTANCE unbreakable, DyedItemColor(int), ItemAttributeModifiers(list),
 * renderTooltip 4 params (direct)
 */
