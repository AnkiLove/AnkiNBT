...
final class EditorDock {
    ...
    static float renderSizeControl(LegacyGuiGraphics graphics, Font font, int width, int height,
    ...
    private static void renderAdjustButton(LegacyGuiGraphics graphics, Font font, Bounds bounds,
        ...
        graphics.drawString(font, icon,
                ...
                hovered ? UiTheme.textMain() : UiTheme.textDim(), false);
        if (hovered) graphics.renderTooltip(font, tooltip, mouseX, mouseY);
    }

    private static void drawBorder(LegacyGuiGraphics graphics, Bounds bounds, int color) {
